...
class LongVideoProcessor:
    ...
    def __init__(self, config_path: str = "video_analyzer/configs/inference_config.yaml", video_name: str = None):
        """
        긴 영상 비디오 전처리기 초기화
        
        Args:
            config_path (str): 설정 파일 경로
            video_name (str, optional): 비디오 이름. None인 경우 영상별 디렉토리 생성 안함
        """
        # PyTorch 설정 최적화
